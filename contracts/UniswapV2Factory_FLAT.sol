...
contract UniswapV2ERC20 is IUniswapV2ERC20 {
    ...
    string public constant name = 'CremePie LPs';
    string public constant symbol = 'CremePie-LP';
...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        uint balance0Adjusted = balance0.mul(10000).sub(amount0In.mul(5));
        uint balance1Adjusted = balance1.mul(10000).sub(amount1In.mul(5));
